...
*/
// TODO check the different kubebuilder annotation and code generator options like below
 ...
 */
import (
	// TODO package for batch group. Since we are re-using the Job Kind from there
	// TODO check how this file's importing needs to be updated when dependent api group-versions change
	batchv1beta1 "k8s.io/api/batch/v1beta1"
	corev1 "k8s.io/api/core/v1"
	// The one below was generated by kubebuilder init, the others added later
...
type CronJobSpec struct {
	...
	// TODO why is this a pointer ? possibly to distinguish between explicitly set vs unspecified
	// +optional
	...
	// TODO taken straight from the existing batch api group v1beta1 version
...
type CronJobStatus struct {
	...
	// TODO why is this a slice of ObjectReferences in corev1 ? Job template spec was in batch/v1beta1
	// +optional
